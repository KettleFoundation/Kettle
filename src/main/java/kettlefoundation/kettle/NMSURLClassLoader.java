...
public class NMSURLClassLoader extends URLClassLoader {
...

    {
        ...
        this.remapper = new NMSServerRemapper(this.jarMapping);
    }

    public NMSURLClassLoader(final URL[] urls, final ClassLoader parent) {
        super(urls, parent);
        this.classes = new HashMap<>();
    }

    public NMSURLClassLoader(final URL[] urls) {
        super(urls);
        this.classes = new HashMap<>();
    }

    public NMSURLClassLoader(final URL[] urls, final ClassLoader parent, final URLStreamHandlerFactory factory) {
